  ...
  static List<AsignaturaModelMock> obtenerAsignaturas() {
    return [
      AsignaturaModelMock(
        ...
        notas: [
          {'titulo': 'Examen Álgebra', 'nota': '7.5'},
          {'titulo': 'Examen Geometría', 'nota': '8.0'},
        ],
        excursiones: [],
      ),
      AsignaturaModelMock(
        ...
        notas: [
          {'titulo': 'Examen Literatura', 'nota': '7.0'},
          {'titulo': 'Examen unidad 4', 'nota': '5.4'},
        ],
        excursiones: [
      ...
      AsignaturaModelMock(
        ...
        notas: [
          {'titulo': 'Examen Biología', 'nota': '8.5'},
        ],
        excursiones: [
      ...
      AsignaturaModelMock(
        ...
        notas: [
          {'titulo': 'Examen Grammar', 'nota': '9.0'},
        ],
        excursiones: [
      ...
      AsignaturaModelMock(
        ...
        notas: [
          {'titulo': 'Examen Geografía', 'nota': '6.5'},
        ],
        excursiones: [
      ...
      AsignaturaModelMock(
        ...
        notas: [
          {'titulo': 'Examen Pintura', 'nota': '6.8'},
        ],
        excursiones: [
      ...
      AsignaturaModelMock(
        ...
        notas: [
          {'titulo': 'Prueba resistencia', 'nota': '7.2'},
        ],
        excursiones: [
      ...
      AsignaturaModelMock(
        ...
        notas: [
          {'titulo': 'Examen Solfeo', 'nota': '6.8'},
          {'titulo': 'Examen Canción', 'nota': '8.2'},
        ],
        excursiones: [
