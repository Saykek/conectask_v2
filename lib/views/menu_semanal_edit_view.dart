    ...
    return SingleChildScrollView(
      ...
      child: DataTable(
        ...
        rows: visibles.asMap().entries.map((entry) {
          ...
          final fechaObj = DateTime.parse(dia.fecha);
          final nombreDia =
              miFecha.DateUtils.diasSemana()[fechaObj.weekday - 1];
                          ...
                          child: Autocompletar(
                            ...
                            onChanged: (value) {
                              if (realIdx >= menu.length) {
                                debugPrint(
                                  "⚠️ Índice fuera de rango: $realIdx (menu.length=${menu.length})",
                                );
                                return;
                              }

                              setState(() {
                                final comidas = List<ComidaModel>.from(
                                  menu[realIdx].comidas,
                                );
                          ...
                          onPressed: () async {
                            ...
                            if (nuevaUrl != null) {
                              setState(() {
                                menu[realIdx] = menu[realIdx].copyWith(
                                  comidas: List.from(menu[realIdx].comidas)
                                    ..[0] = menu[realIdx].comidas[0].copyWith(
                                      url: nuevaUrl,
                                    ),
                                );
                              });
                          ...
                          child: Autocompletar(
                            ...
                            onChanged: (value) {
                              setState(() {
                                menu[realIdx] = menu[realIdx].copyWith(
                                  comidas: List.from(menu[realIdx].comidas)
                                    ..[1] = menu[realIdx].comidas[1].copyWith(
                                      nombre: value,
                                    ),
                                );
                              });
                              ...
                              setState(() {
                                menu[realIdx] = menu[realIdx].copyWith(
                                  cenas: List.from(menu[realIdx].cenas)
                                    ..[0] = menu[realIdx].cenas[0].copyWith(
                                      nombre: value,
                                    ),
                                );
                              });
                          ...
                          child: Autocompletar(
                            ...
                            onChanged: (value) {
                              setState(() {
                                menu[realIdx] = menu[realIdx].copyWith(
                                  cenas: List.from(menu[realIdx].cenas)
                                    ..[1] = menu[realIdx].cenas[1].copyWith(
                                      nombre: value,
                                    ),
                                );
                              });
